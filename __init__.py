...
from db_setup import Base, Category, User, MenuItem
...
CLIENT_ID = json.loads(
	# Give full path to client_secrets.json for apache
	open('/var/www/FlaskApp/ApacheBeefCatalog/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
	...
	# Give full path to client_secrets.json for apache
        oauth_flow = flow_from_clientsecrets('/var/www/FlaskApp/ApacheBeefCatalog/client_secrets.json', scope='')
...
if __name__ == '__main__':
   ...
   # for apache deployment 
    app.run(host='54.69.81.35', port=80)
